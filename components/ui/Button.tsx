...
export function Button(
  ...
  const base =
    "c-button inline-flex items-center justify-center gap-2 rounded-xl font-medium outline-none focus-visible:ring-2 focus-visible:ring-blue-500/70 disabled:opacity-60 cursor-pointer disabled:cursor-not-allowed";
